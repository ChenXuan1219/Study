...
//    val hdfs_parquet_file_save_path = "Flink/src/main/scala/com/flink/sodata/parquet"
//    env.enableCheckpointing(1000)
//    val port = 9999
//    val source = env.readTextFile("Flink/src/main/scala/com/flink/sodata/tagdata")
//
